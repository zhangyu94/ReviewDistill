...
<template>
  ...
  >
    <div class="w-full max-w-md rounded-[4px] border border-[var(--ch-color-border)] bg-[var(--ch-color-background)] p-4 text-xs shadow-lg">
      ...
      <h3 class="mb-1.5 font-medium">Deactivate a group</h3>
      ...
      <div class="flex justify-end gap-1.5">
        <button class="ch-btn ch-btn-outline" type="button" title="Close this dialog" @click="hide">Close</button>
        <button
