...
- [Extract](./extract.md) — how comments and manuscript context are chosen

Client source: [`client/`](https://github.com/zhangyu94/ReviewDistill/tree/main/client). `pip install -e` builds that UI so `reviewdistill ui` can host it; see [`client_build.py`](https://github.com/zhangyu94/ReviewDistill/blob/main/client_build.py).
